...
export const EditorPanel = function({ editing }) {
  ...
  return (
    <div className="z-10 top-0 right-0 absolute bg-gray-700 h-full text-gray-50 rounded-l-2xl shadow-xl w-60 divide-y divide-grey-50 p-2 transition-transform transform translate-x-0">
